...
class DetailPanduanPhUpDownPage extends StatefulWidget {
  final int idPanduan;
  const DetailPanduanPhUpDownPage({super.key, required this.idPanduan});

  @override
  State<DetailPanduanPhUpDownPage> createState() =>
      _DetailPanduanPhUpDownPageState();
}

class _DetailPanduanPhUpDownPageState extends State<DetailPanduanPhUpDownPage> {
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Image.network(
                                        'https://img.youtube.com/vi/a3xntbeWP4o/maxresdefault.jpg',
                                        fit: BoxFit.cover,
                                        errorBuilder:
