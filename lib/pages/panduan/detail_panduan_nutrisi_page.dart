...
class DetailPanduanNutrisiPage extends StatefulWidget {
  final int idPanduan;
  const DetailPanduanNutrisiPage({super.key, required this.idPanduan});

  @override
  State<DetailPanduanNutrisiPage> createState() =>
      _DetailPanduanNutrisiPageState();
}
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Image.network(
                                        'https://img.youtube.com/vi/mcNSnsWAS5A/maxresdefault.jpg',
                                        fit: BoxFit.cover,
                                        errorBuilder:
